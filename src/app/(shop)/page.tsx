...
export const metadata = {
  ...
  description:
    "فروشگاه اینترنتی سبزفراز مرجع تخصصی خرید قطعات الکترونیک، ماژول، سنسور، برد آردوینو و ESP، لوازم لحیم‌کاری و ابزار دقیق با موجودی واقعی، قیمت مناسب، ضمانت اصالت و ارسال سریع از اصفهان به سراسر کشور.",
};
