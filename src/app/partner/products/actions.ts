...
فقط یک JSON با این ساختار دقیق برگردان (بدون Markdown fence، بدون توضیح اضافه):
{
  ...
  "description": "توضیح کامل حرفه‌ای محصول. حتماً با خط جداکننده (-----) شروع و تمام کن. شامل: معرفی جذاب، مشخصات فنی با ایموجی ⚙️ و لیست، کاربردهای رایج با ایموجی 📌 و لیست، نکات مهم با ایموجی 💡 و لیست، محتویات بسته با ایموجی 📦 و لیست، و در انتها دو خط درباره فروشگاه سبزفراز با آدرس sabzfaraz.ir. از تگ‌های HTML مثل <p>, <strong>, <h3>, <ul>, <li> استفاده کن و متن را طولانی، دقیق و فروشگاهی بنویس.",
...
نمونه‌ی دقیق سبک توضیح که باید تولید کنی (فقط قالب، متن را خودت بنویس):

--------------------------------------------------------------------------------------------------------------
[معرفی محصول: ۲-۳ جمله جذاب]
...
--------------------------------------------------------------------------------------------------------------
فروشگاه اینترنتی سبزفراز (سبز فراز)
عرضه‌کننده‌ی انواع قطعات الکترونیک، لوازم لحیم‌کاری، ابزار دقیق و تجهیزات جانبی.
🌐 sabzfaraz.ir | sabz faraz
`.trim();
