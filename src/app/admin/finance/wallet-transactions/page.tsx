...
export default async function AdminWalletTransactionsPage() {
  ...
  return (
    <div>
      ...
      <p className="text-sm text-gray-500 mb-5">مجموع موجودی فعلی همه کیف‌پول‌ها: <b>{totalWallets.toLocaleString("fa-IR")} تومان</b></p>

      <div className="admin-card">
        <table className="admin-table">
          <thead><tr><th>کاربر</th><th>نوع</th><th>مبلغ</th><th>مانده پس از تراکنش</th><th>شرح</th><th>تاریخ</th></tr></thead>
          <tbody>
            {(transactions ?? []).map((t) => (
              <tr key={t.id}>
