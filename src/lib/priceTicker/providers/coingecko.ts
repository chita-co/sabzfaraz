...
const TOP_CRYPTO_IDS = [
  ...
  "elrond-erd-2", "kava", "theta-token", "arweave", "celo", "stacks", "mina", "kucoin-shares", "huobi-token", "gatechain-token", "curve-dao-token", "loopring", "nexo", "pancakeswap-token", "compound", "yearn-finance",
   "1inch", "basic-attention-token", "enjincoin", "holotoken", "ravencoin",
  "ontology", "nano", "harmony", "sushi", "convex-finance", "jito", "bonk", "dogwifcoin", "popcat", "worldcoin",
  "ondo-finance", "celestia", "sui", "sei", "aptos", "opulus",
  "zksync", "blast", "dymension", "eigenlayer", "puffer-finance", "aioz-network",
  "helium", "wemix", "galxe", "dexe", "akash-network", "casper-network",
];
